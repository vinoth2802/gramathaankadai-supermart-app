              ...
              <tbody className="divide-y divide-slate-50">
                {computed.map((row, idx) => (
                  <tr key={row._key} className="hover:bg-amber-50 transition">
                    ...
                    <td className="border-r border-slate-100 p-0">
                      <input type="number" min="0" value={row.itemCount} onChange={e => updateRow(idx, 'itemCount', e.target.value)}
                    ...
                    <td className="border-r border-slate-100 p-0">
                      <input type="number" min="0" value={row.qty} onChange={e => updateRow(idx, 'qty', e.target.value)}
                        className={`${cellCls} text-right font-semibold text-slate-700`} placeholder="0" />
                    </td>
                    <td className="border-r border-slate-100 p-0">
                      <input type="number" min="0" value={row.freeQty} onChange={e => updateRow(idx, 'freeQty', e.target.value)}
                        className={`${cellCls} text-right`} placeholder="0" />
                    </td>
                    <td className="border-r border-slate-100 p-0">
