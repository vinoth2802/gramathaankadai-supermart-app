...
export default function AddItemModal({ onClose, onSave, onSaveAndNew, uoms = [], editData = null, existingItems = [], initialType = 'Product', categories = [] }) {
  ...
  const handleSave    = () => { const p = validate(); if (p) onSave(p); };
  const handleSaveAndNew = () => { const p = validate(); if (p) onSaveAndNew(p); };
          ...
          {activeTab === 'Pricing' && (
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 space-y-2">
                ...
                <Field label="MRP (₹)">
                  <input type="number" min="0" step="0.01" value={form.mrp} onChange={e => setF('mrp', e.target.value)} placeholder="0.00" className={inp} />
                </Field>
                <Field label="Sale Price (₹)">
                  <input type="number" min="0" step="0.01" value={form.salesPrice} onChange={e => setF('salesPrice', e.target.value)} placeholder="0.00" className={inp} />
                </Field>
                <Field label="Purchase Price (₹)">
                  <input type="number" min="0" step="0.01" value={form.purchasePrice} onChange={e => setF('purchasePrice', e.target.value)} placeholder="0.00" className={inp} />
                </Field>
              </div>
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 space-y-2">
                ...
                <Field label="Wholesale Price (₹)">
                  <input type="number" min="0" step="0.01" value={form.wholesalePrice} onChange={e => setF('wholesalePrice', e.target.value)} placeholder="0.00" className={inp} />
                </Field>
                <Field label="Wholesale Qty">
                  <input type="number" min="0" value={form.wholesaleQty} onChange={e => setF('wholesaleQty', e.target.value)} placeholder="0" className={inp} />
                </Field>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 space-y-4">
                ...
                <Field label="Opening Qty">
                  <input type="number" min="0" value={form.openingQty} onChange={e => setF('openingQty', e.target.value)} placeholder="0" className={inp} />
                </Field>
                <Field label="At Price (₹)">
                  <input type="number" min="0" step="0.01" value={form.atPrice} onChange={e => setF('atPrice', e.target.value)} placeholder="0.00" className={inp} />
                </Field>
              </div>
              ...
              <div className="bg-rose-50 border border-rose-200 rounded-xl p-4 space-y-4">
                ...
                <Field label="Minimum Stock">
                  <input type="number" min="0" value={form.minStock} onChange={e => setF('minStock', e.target.value)} placeholder="0" className={inp} />
                </Field>
                <Field label="Re Order Level">
                  <input type="number" min="0" value={form.reorderLevel} onChange={e => setF('reorderLevel', e.target.value)} placeholder="0" className={inp} />
                </Field>
              </div>
                          ...
                          return (
                            <tr key={row.id} className="hover:bg-slate-50"
                              ...
                              <td className="w-24 px-3 py-2 border-r border-slate-100">
                                <input type="number" min="0" value={row.qty} onChange={e => updateRawMaterial(idx, 'qty', e.target.value)}
                              ...
                              <td className="w-44 px-3 py-2 text-right border-r border-slate-100">
                                <input type="number" min="0" value={row.purchasePrice} onChange={e => updateRawMaterial(idx, 'purchasePrice', e.target.value)}
