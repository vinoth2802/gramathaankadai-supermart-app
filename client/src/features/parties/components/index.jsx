...
import { usePartySave } from '../hooks/usePartySave.js';
import { EditSaleModal } from '@features/sales/components/History.jsx';
import { EditPurchaseModal } from '@features/purchases/components/History.jsx';
...
export default function Parties() {
  ...
  const { handleSave, handleSaveAndNew, isSaving } = usePartySave({
    editParty,
    onClose: closeModal,
    onSaveAndNewSuccess: () => setModalKey(k => k + 1),
  });
