...
function Th({ label, className = '' }) {
  return (
    <th className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 bg-slate-50 border-b border-slate-100 whitespace-nowrap ${className}`}>
...
function RowMenu({ onDelete }) {
  ...
  const items = [
    { label: 'Edit',         fn: null,     danger: false },
    { label: 'Print',        fn: null,     danger: false },
    { label: 'Duplicate',    fn: null,     danger: false },
    { label: 'View History', fn: null,     danger: false },
      ...
      <div className="px-6 py-5 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <button className="flex items-center gap-1.5 text-xl font-bold text-slate-800 hover:text-blue-600 transition">
            Sale Invoices <ChevronDown size={18} />
          </button>
            ...
            <table className="w-full text-sm min-w-[960px]">
              <thead>
                <tr>
                  ...
                  <Th label="Amount" className="text-right" />
                  <Th label="Balance" className="text-right" />
                  <Th label="Due Date" />
                  <Th label="Status" />
