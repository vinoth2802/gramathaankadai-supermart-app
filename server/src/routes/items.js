...
router.post('/', async (req, res) => {
  try {
    const { shortName, itemCode, type, category, hsnCode, description, batch, uom, pcsPerUnit, purchasePrice, mrp, salesPrice, gstRate, stock, reorderLevel, expiryDate } = req.body;
